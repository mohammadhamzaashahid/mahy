...
// Flat list of every real shop product (the catalog actually served by
// /shop/[id], keyed by partNumber) — used by the sitemap to list real URLs.
export const allShopProducts = productsSources.flat();
