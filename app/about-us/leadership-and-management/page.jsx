  ...
  return (
    <main className="bg-white">
      <SubPageHeading
        ...
        image="/assets/about-us/leadership-and-management/businessman-standing-front-large-glass-building-business-corporative-concept-generative-ai.jpg_f65dkk.jpg"
        align="center"
        fullHeight
      />
      <GovernanceTabs />
