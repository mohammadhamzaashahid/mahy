...
export const metadata = {
  ...
  description:
    "MAHY Khoory Group supplies GRUNDFOS and other leading pumping solutions engineered for submerged operation in boreholes, sumps, tanks and drainage applications.",
  alternates: { canonical: "/products/pumping-solutions" },
};
