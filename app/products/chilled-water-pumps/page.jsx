  ...
  const overviewItems = [
    {
      ...
      bgImage:
        "/assets/products/chilled-water-pumps/chilled-water-pumps2.png_tslxu6.jpg",
...

    {
      ...
      bgImage: "/assets/shared/factory-with-blue-pipe-blue-pipe-with-word-power-it_fseudd.jpg",
    ...
    },
    {
      ...
      bgImage: "/assets/products/chilled-water-pumps/comprehensive-pumping-system-4_do1k9f.jpg",
...

    {
      ...
      bgImage: "/assets/shared/tpumps2_qbtnwi.jpg",
  ...
  const applications = [
    {
      ...
      bgImage:
        "/assets/products/chilled-water-pumps/HVAC_Chilled_water_network_ohvuyf.jpg",
    },
    {
      title: "Central A/C Systems",
      text: "Supports centralized chilled-water air-conditioning systems in mixed-use developments.",
      bgImage:
        "/assets/products/chilled-water-pumps/Central_AC_System_uqjejj.jpg",
    },
    // {
    ...
    // },
    {
      ...
      bgImage:
        "/assets/products/chilled-water-pumps/Commercial_Building_loops_lazkbs.jpg",
...

    {
      ...
      bgImage:
        "/assets/products/chilled-water-pumps/Industrial_Cooling_process_k1maer.jpg",
    },
  ];
    ...
    <main>
      ...
      <div className="my-20">
        <SolarPanelImagesGrid
          images={[
            "/assets/products/chilled-water-pumps/Copilot_20260421_090656_huhtpp.png",
            "/assets/products/chilled-water-pumps/chilled-water-pumps3.png_lug0j8.jpg",
            "/assets/products/chilled-water-pumps/chilled-water-pumps2.png_tslxu6.jpg",
            "/assets/products/chilled-water-pumps/vertical-shot-river-roads-city-clear-blue-sky_rbu8an.jpg",
          ]}
          heading="Overview"
          items={overviewItems}
          text1="Trusted"
