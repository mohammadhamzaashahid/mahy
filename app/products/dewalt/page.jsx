...
export const metadata = {
  ...
  description:
    "MAHY Khoory Group distributes DEWALT power tools and safety footwear engineered for confidence, efficiency and safety across every task.",
  alternates: { canonical: "/products/dewalt" },
};
