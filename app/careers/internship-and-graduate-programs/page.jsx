    ...
    return (
        <main>
            <SubPageHeading
                ...
                fullHeight
                image={"/assets/careers/internship-and-graduate-programs/internship-graduates-prog.jpg_uq1d6i.jpg"}
            />
            <section className="max-w-7xl mx-auto px-5 py-15 md:pt-25">
                <CompaniesSectors
                    image={"/assets/careers/internship-and-graduate-programs/dubai-city-skyline-showing-burj-khalifa-2014.jpg_jx4cxo.jpg"}
                    image2={"/assets/careers/internship-and-graduate-programs/panoramic-view-dubai-city-illuminated-neon-spectrum.jpg_v9thiu.jpg"}
                    texts={[
