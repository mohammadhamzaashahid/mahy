...
export const metadata = {
  ...
  description:
    "Al Dhafra Paper Manufacturing builds on MAHY Khoory Group's paper recycling expertise dating back to 1987, operating within an integrated recycling and manufacturing ecosystem in the UAE.",
  alternates: { canonical: "/companies/details/al-dhafra-paper-manufacturing" },
};
...
function AlDhafraPaper() {
  ...
  return (
    <main>
      <CompanyOverview
        video={"/assets/companies/details/al-dhafra-paper-manufacturing/Video_Project_7_z3gnr8.mp4"}
      ...
      <WhoWeAre
        ...
        showButton={false}
        invert={false}
        image="/assets/companies/details/al-dhafra-paper-manufacturing/Our_Mission_2_rxnnh3.jpg"
      ...
      <WhoWeAre
        ...
        image="/assets/companies/details/al-dhafra-paper-manufacturing/Our_Vision_idubjb.jpg"
        imageAlt="Our Vision"
      ...
      <FeaturesEngineeringSection
        ...
        items={overview}
        textPosition="left"
        image="/assets/companies/details/al-dhafra-paper-manufacturing/ADPMCL_Base_image_rc71lw.png"
      />
    </main>
  );
}
