...
function Filters({ filters, search }) {
  ...
  backdrop-saturate-150`}
            ...
            <div className={`
                ...
                overflow-y-scroll fixed z-40 transition-opacity duration-500 inset-0 col-span-2 px-4 py-7 rounded-3xl bg-white border border-[#E7E3DA] lg:sticky lg:top-20 h-fit mb-10 lg:mb-0`}>
